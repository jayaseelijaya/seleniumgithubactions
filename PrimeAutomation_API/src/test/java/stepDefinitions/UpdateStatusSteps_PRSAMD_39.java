...
//
//public class UpdateStatusSteps_PRSAMD_39 extends CommonUtils {
//	RequestSpecification _RESP_SPEC;
//	static Response _RESPONSE;
//	String resp;
//	String expected_value;
//	final static Logger logger = Logger.getLogger(UpdateStatusSteps_PRSAMD_39.class);
//
//	// *********************GIVEN BLOCK*******************************
...
//				System.getProperty("user.dir") + "/src/test/resources/testData/TestCaseData_PRSAMD_39.xlsx", sheetName);
//		String uuid = testData.get(RowNumber).get("uuid");
//		String status = testData.get(RowNumber).get("status");
//		String errordetails = testData.get(RowNumber).get("error details");
//		String notes = testData.get(RowNumber).get("notes");
//		JSONObject payload = new JSONObject();
//		payload.put("uuid", uuid);
//		payload.put("status", status);
//		payload.put("error details", errordetails);
