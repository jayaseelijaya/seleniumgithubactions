...
public class DUU_ImageUpload_SSR2336_ApplicationcardErrorMessage {

	PropertiesFileReader reader = new PropertiesFileReader();
	final static Logger logger = Logger.getLogger(DUU_ImageUpload_SSR2336_ApplicationcardErrorMessage.class);
	...
	public void user_clicks_on_surgeon_which_deosn_t_have_application_card_associate()
			throws IOException, InterruptedException {
		try {
			sp.selectSurgeonWithNoapplicationCard();
	...
	public void the_error_message_is_displayed(String string) {
		try {
			...
			logger.info("the error message displayed as : " + msg);
			LoginPage.driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(10));
			screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
		} catch (Exception e) {
			logger.error("Step: Caught exception:: " + e.toString());
