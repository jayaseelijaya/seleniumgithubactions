Feature: SSR3341 - Data Upload Utility shall allow the S&N HIL Manager to change the Active Status of an Image Center from 'Inactive' to 'Active'. 

  @facilityLinking_TC3474
  Scenario Outline: TC3474 - S&N HIL Manager_Verify Data Upload Utility shall allow the S&N HIL Manager to change a status of an Image Center from Inactive to Active
    ...
    #Type status Inactive in search bar (not functional)
