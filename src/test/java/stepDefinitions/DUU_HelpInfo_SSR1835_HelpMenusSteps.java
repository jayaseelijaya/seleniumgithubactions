...
public class DUU_HelpInfo_SSR1835_HelpMenusSteps {
   ...
   public void the_content_of_pdf_viewer_shall_be_displayed_in_black_colour() {
	   try {
	       String color = hp.getPDFContentColor();
	       logger.info("PDF Content Color is: " + color);
	       screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
			logger.error("Step: Caught exception:: " + e.toString());
			Assert.fail("Unable to get color of PDF content");
			exception = e;
		}
   }
   ...
   public void the_user_clicks_on_show_document_outline() {
	   try {
		   hp.clickDocumentOutline();
		   logger.info("User clicked show document outline button");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
			logger.error("Step: Caught exception:: " + e.toString());
			Assert.fail("Unable to click Document Outline button");
			exception = e;
		}
   }
   
   @Then("the user shall not be able to click on show document outline icon if no outline available")
   public void the_user_shall_not_be_able_to_click_on_show_document_outline_icon_if_no_otline_available() {
	   try {
	       assertFalse(hp.isDocumentOutlineEnabled());
	       logger.info("Document outline is unable to be clicked because it is not available");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
			logger.error("Step: Caught exception:: " + e.toString());
			Assert.fail("Document Outline is enabled");
			exception = e;
	   }
   }
   ...
   public void the_user_clicks_on_show_attachments() {
       try {
    	   hp.clickShowAttachments();
    	   logger.info("User Clicks show attachments button");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
       } catch (Exception e) {
			logger.error("Step: Caught exception:: " + e.toString());
			Assert.fail("Unabled to click show attachments button");
			exception = e;
		}
   }
   ...
   public void the_user_shall_not_be_able_to_click_on_show_attachments_icon_if_no_attachments_available() {
	   try {
	       assertFalse(hp.isShowAttachmentsEnabled());
	       logger.info("Show Attachments is unable to be clicked because it is not available");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
			logger.error("Step: Caught exception:: " + e.toString());
			Assert.fail("Show Attachments Button is enabled");
			exception = e;
	   }
   }
   ...
   public void the_user_clicks_on_search_icon_at_top_left_bar_of_pdf_viewer() {
	   try {
		   ...
		   logger.info("User clicks search icon in pdf viewer");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Unable to click search icon in pdf viewer");
		   exception = e;
	   }
   }
   ...
   public void a_find_search_bar_with_text_find_in_document_shall_be_displayed() {
	   try {
		   assertTrue(hp.isSearchBarDisplayed());
		   logger.info("PDF Viewer Search Bar is displayed");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("PDF Viewer search bar is not displayed");
		   exception = e;
	   }
   }
   ...
   public void the_states_find_the_previous_occurrence_of_the_phrase_shall_be_displayed() {
	   try {
		   assertTrue(hp.isShowPreviousButtonDisplayed());
		   logger.info("PDF Viewer Find Previous Button in Search Bar is displayed");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("PDF Viewer find previous button in search bar is not displayed");
		   exception = e;
	   }
   }
   ...
   public void the_states_find_the_next_occurrence_of_the_phrase_shall_be_displayed() {
	   try {
		   assertTrue(hp.isShowNextButtonDisplayed());
		   logger.info("PDF Viewer Find Next Button in Search Bar is displayed");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("PDF Viewer find next button in search bar is not displayed");
		   exception = e;
	   }
   }  
   ...
   public void the_checkbox_for_highlight_all_shall_be_displayed() {
	   try {
		   assertTrue(hp.isHighlightAllCheckboxDisplayed());
		   logger.info("PDF Viewer Highlight All Checkbox in Search Bar is displayed");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("PDF Viewer highlight all checkbox in search bar is not displayed");
		   exception = e;
	   }
   }
   ...
   public void the_checkbox_for_match_case_shall_be_displayed() {
	   try {
		   assertTrue(hp.isMatchAllCheckboxDisplayed());
		   logger.info("PDF Viewer Match All Checkbox in Search Bar is displayed");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("PDF Viewer match all checkbox in search bar is not displayed");
		   exception = e;
	   }
   }
   ...
   public void the_checkbox_for_whole_words_shall_be_displayed() {
	   try {
		   assertTrue(hp.isMatchCaseCheckboxDisplayed());
		   logger.info("PDF Viewer Match Case Checkbox in Search Bar is displayed");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("PDF Viewer Match Case checkbox in search bar is not displayed");
		   exception = e;
	   }
   }
   ...
   public void the_upload_file_icon_shall_be_displayed() {
       try {
    	   assertTrue(hp.isUploadFilesPageIconDisplayed());
    	   logger.info("Upload file icon is displayed");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
       } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Upload file icon is not displayed");
		   exception = e;
	   }
   }
   ...
   public void upload_button_shall_be_displayed() {
       try {
    	   assertTrue(hp.isUploadFilesPageUploadButtonDisplayed());
   ...
   @When("User clicks on Upload files from left menu bar")
   public void press_upload_button_from_left_menu_bar() {
       try {
    	   LoginPage.driver.switchTo().defaultContent();
    	   hp.pressUploadFilesButton();
    	   logger.info("User clicks upload files button from left menu bar");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
       } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Unable to click upload files button");
		   exception = e;
	   }
   }
   
   @When("the user clicks on upload status from left menu bar")
   public void press_upload_status_button_from_left_menu_bar() {
	   try {
		   LoginPage.driver.switchTo().defaultContent();
    	   hp.pressUploadStatusButton();
    	   logger.info("User clicks upload status button from left menu bar");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Unable to click upload status button");
		   exception = e;
	   }
   }
   
   @When("the user clicks on history from left menu bar")
   public void press_history_button_from_left_menu_bar() {
	   try {
		   LoginPage.driver.switchTo().defaultContent();
    	   hp.pressHistoryButton();
    	   logger.info("User clicks history button from left menu bar");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Unable to click history button");
		   exception = e;
	   }
   }
   
   @When("the user clicks on audit log from left menu bar")
   public void press_audit_log_button_from_left_menu_bar() {
	   try {
		   LoginPage.driver.switchTo().defaultContent();
    	   hp.pressAuditLogButton();
    	   logger.info("User clicks audit log button from left menu bar");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Unable to click audit log button");
		   exception = e;
	   }
   }
   
   @When("the user clicks on imaging links from left menu bar")
   public void press_imaging_links_button_from_left_menu_bar() {
	   try {
		   LoginPage.driver.switchTo().defaultContent();
    	   hp.pressImagingLinksButton();
    	   logger.info("User clicks imaging links button from left menu bar");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Unable to click imaging links button");
		   exception = e;
	   }
   }
   
   @When("the user clicks on settings from left menu bar")
   public void press_settings_button_from_left_menu_bar() {
	   try {
		   LoginPage.driver.switchTo().defaultContent();
    	   hp.pressSettingsButton();
    	   logger.info("User clicks settings button from left menu bar");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch (Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Unable to click settings button");
		   exception = e;
	   }
   }
   
   @Then("the right side header is displayed as audit log")
   public void check_audit_log_header() {
	   try {
		   assertTrue(hp.checkAuditLogHeader());
		   logger.info("Audit log header is displayed");
		   screenshot.screenshot(new Throwable().getStackTrace()[0].getMethodName(), LoginPage.driver);
	   } catch(Exception e) {
		   logger.error("Step: Caught Exception:: " + e.toString());
		   Assert.fail("Unable to find Audit Log Header");
		   exception = e;
	   }
   }
}