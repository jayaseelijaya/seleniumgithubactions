Feature: SSR3336 - Data Upload Utility shall allow the S&N HIL Manager to create a link between an Image Center and a Hospital account when selecting the facility, regardless of the facilities Inactive, Active, or N/A status
