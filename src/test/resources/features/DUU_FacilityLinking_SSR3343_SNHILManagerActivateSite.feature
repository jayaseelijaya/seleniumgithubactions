Feature: SSR3343 - Data Upload Utility shall allow the S&N HIL Manager to change the Active Status of a Hospital from 'Inactive' to 'Active'.  

  @facilityLinking_TC0927
  Scenario Outline: TC0927 - S&N HIL Manager_Verify Data Upload Utility shall allow the S&N HIL Manager to change a status of a Hospital from 'Inactive' to 'Active'
