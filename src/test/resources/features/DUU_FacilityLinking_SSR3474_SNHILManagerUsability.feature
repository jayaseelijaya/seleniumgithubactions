Feature: SSR3474 - Verify usability of imaging links screen for specified roles
  ...
  Scenario Outline: TC0940 - Hospital Admin_Verify the Usability of Imaging links screen
	...
	@facilitylinking_TC3469
	Scenario Outline: TC3469 - S&N HIL Manager_Verify DUU allows S&N HIL Manager to view account details for an Image Center account and Hospital account
