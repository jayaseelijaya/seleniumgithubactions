Feature: SSR5734 - Verifying Data Upload Utility will set the status of a facility without an active license to NA
	
	@facilityLinking_TC7725
	Scenario Outline: TC7725 - S&N HIL Manager_ Verify  DUU displays the facility status as NA by default in the Imaging Links table
