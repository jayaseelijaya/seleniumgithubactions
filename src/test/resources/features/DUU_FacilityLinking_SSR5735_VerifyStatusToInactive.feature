Feature: SSR5735 - Verifying Data Upload Utility will change the Status of a facility from NA to Inactive after the facility has been given a license

	@facilityLinking_TC7727
	Scenario Outline: TC7727 - S&N HIL Manager_ Verify the facility status in the Imaging Link table is changed from NA to Inactive once the facility has a Data Upload Utility license
    ...
    Then the right section table of Imaging Links screen is displayed
      ...
      | Website                     |
      | Contact number              |
    #User gives Selected Facility (not automatable)
		#User checks status of updated facility
