Feature: SSR1835 - Verifying Data-Upload Utility Application shall provide help menu details.
	...
	@help_TC0693
  Scenario Outline: TC0693 - Verify DUU web app shall provide help menus for all screens.
  ...
  @help_TC1232
  Scenario Outline: TC1232 - Verify DUU web app shall provide help menus for all screens for SN HIL Manager.
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
	...
	@help_TC1236
  Scenario Outline: TC1236 - Verify DUU web app shall provide help menus for all screens for hospital admin.
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
	...
	@help_TC1240
  Scenario Outline: TC1240 - Verify DUU web app shall provide help menus for all screens IC technicians.
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
	...
	@help_TC1237
  Scenario Outline: TC1237 - Verify DUU web app shall provide help menus for all screens for surgeon.
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
	...
	@help_TC1238
  Scenario Outline: TC1238 - Verify DUU web app shall provide help menus for all screens for support staff.
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
	...
	@help_TC1283
  Scenario Outline: TC1283 - Verify DUU web app shall help menus tool feature for IC technicians .
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
	...
	@help_TC1286
  Scenario Outline: TC1286 - Verify DUU web app shall help menus tool feature for IC Admin .
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
	...
	@help_TC1287
  Scenario Outline: TC1287 - Verify DUU web app shall help menus tool feature for hospital Admin .
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
	...
	@help_TC1288
  Scenario Outline: TC1288 - Verify DUU web app shall help menus tool feature for surgeon .
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
  ...
  @help_TC1289
  Scenario Outline: TC1289 - Verify DUU web app shall help menus tool feature for support staff .
    Given that the user is logged in to Data-Upload Utility Application through chrome "<user>"
    And file dashboad page is displayed to user
    When user clicks on help center menu icon
    Then pdf viewer is displayed on left menu panel
