Feature: SSR2229 - Verifying all user interfaces shall scale appropriately when used on a computer with minimum resolution of 1280x720 (16:9 aspect ratio) or 1280x800 (16:10 aspect ratio).
