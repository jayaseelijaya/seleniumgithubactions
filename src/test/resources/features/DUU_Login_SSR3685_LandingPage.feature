Feature: SSR3685 - The Data Upload Utility shall allow role-based access for the S&N HIL Manager users to the following tabs in the left panel menu: Upload Dashboard, History, Audit Log, Imaging Links
