Feature: SSR1731 - Data Upload Utility web app shall allow Admin user to set the timeframe to persist a successful upload in the summary dashboard view between 1-30 days
